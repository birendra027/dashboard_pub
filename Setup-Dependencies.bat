...
exit /b
:NODE_INSTALL
echo Downloading the pinned Node.js 24.18.0 installer...
set "NODE_MSI=%PUBLIC%\node-lts-x64.msi"
powershell -NoProfile -Command "try { Invoke-WebRequest -Uri 'https://nodejs.org/dist/v24.18.0/node-v24.18.0-x64.msi' -OutFile $env:NODE_MSI -UseBasicParsing } catch { exit 1 }"
